...
extension NSLayoutConstraint {
    ...
    static func safeAreaTop(safeAreaView: UIView,
                            otherView: UIView,
                            constant: Float = 0,
                            statusBar: Bool = false) -> NSLayoutConstraint {
                return safeAreaView.safeAreaLayoutGuide.topAnchor.constraint(equalTo: otherView.topAnchor,
                                                                             constant: CGFloat(constant))
    }

    static func safeAreaBottom(safeAreaView: UIView,
                               otherView: UIView,
...
extension UIView {
    ...
    func safeAreaBottom(safeAreaView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.safeAreaBottom(safeAreaView: safeAreaView,
                                                           otherView: self,
                                                           constant: constant)
        constraint.isActive = true
    }
    ...
    func insetConstraints(inSuperview superView: UIView, withInset inset: UIEdgeInsets? = nil) {
        let constraints = NSLayoutConstraint.inset(view: self,
    ...
    func topConstraint(parentView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.top(firstView: self,
    ...
    func leftConstraint(parentView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.left(firstView: self,
                                                 secondView: parentView,
                                                 constant: constant)
        constraint.isActive = true
    }
    ...
    func rightConstraint(parentView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.right(firstView: self,
                                                  secondView: parentView,
                                                  constant: -constant)
        constraint.isActive = true
    }
    ...
    func bottomConstraint(parentView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.bottom(firstView: self,
                                                   secondView: parentView,
                                                   constant: -constant)
        constraint.isActive = true
    }
    ...
    func overConstraint(topItem: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.over(topItem: topItem,
                                                 bottomItem: self,
                                                 constant: constant)
        constraint.isActive = true
    }
    ...
    func aside(leftItem: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.aside(left: leftItem,
                                                  right: self,
                                                  constant: constant)
        constraint.isActive = true
    }
    ...
    func centerYConstraint(parentView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.centerY(firstView: self,
                                                    secondView: parentView,
                                                    constant: constant)
        constraint.isActive = true
    }
    ...
    func centerXConstraint(parentView: UIView, constant: Float = 0) {
        let constraint = NSLayoutConstraint.centerX(firstView: self,
                                                    secondView: parentView,
                                                    constant: constant)
        constraint.isActive = true
    }
